...
{
    #[Route('/',name:'')]
    public function dossier(Request $request, EntityManagerInterface $em, ResponsableRepository $responsableRepository, ChauffeurRepository $chauffeurRepository, FactureRepository $factureRepository): Response
    {
